addEventListener('fetch', event => {
  ...
  async function handleRequest(request) {
    ...
    const url = new URL(request.url)
     ...
     // 验证 URL 是否合法
    if (!url || !url.pathname.includes('PackPlus')) {
        return new Response('Invalid PackPlus release URL', { status: 400 })
    }
...
// 原始链接
// https://github.com/Aniooy/PackPlus/releases/download/ChatGPT/ChatGPT_0.0.1_x64-setup.exe

// 加速链接
// https://github.PackPlus.com/gh/Aniooy/PackPlus/releases/download/ChatGPT/ChatGPT_0.0.1_x64-setup.exe