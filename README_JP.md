...
<p align="center">
    <img src="https://github.com/Sjj1024/PackPlus/raw/main/docs/static/imgs/PackPlus.png" width=138/>
</p>  
...
<div align="left">PackPlus は Mac、Windows、および Linux に対応しており、Android と iOS も間もなくサポート予定です。ローカルに複雑な依存環境をインストールする必要はなく、Github トークンだけで利用できます。また、PackPlus 自体のサイズはわずか約5MBです。最新バージョンについては<a href="[#popular-packages](https://github.com/Sjj1024/PackPlus/releases)">リリースページ</a>をご確認ください。また、PackPlus Web 版も利用できます。<a href="URL_ADDRESS また、PackPlus Web 版も利用できます。<a href="https://PackPlus.pages.dev" target="_blank">PackPlus Web</a>。
...
1. リリースページからアプリをダウンロードし、ダブルクリックしてインストールし、実行します：https://github.com/Sjj1024/PackPlus/releases。 あるいは、ウェブ版を使ってもいいです：<a href="https://PackPlus.pages.dev" target="_blank">PackPlus Web</a>
